  ...
  return (
    <form ref={myForm} onSubmit={(e) => resetForm(e)} className="login-form">
      <div className="form-group">
        ...
        <input
          defaultValue={inputText.spouse_name}
          onChange={(e) =>
            setInputText({ ...inputText, spouse_name: e.target.value })
          }
          className="input"
          type="text"
        ></input>
        ...
        <textarea
          ...
          className="invite-description-box"
          rows="5"
        ></textarea>
        <label className="label">Date of wedding</label>
        <input
          defaultValue={inputText.wedding_date}
          onChange={(e) =>
            setInputText({ ...inputText, wedding_date: e.target.value })
          }
          className="input"
          placeholder="...November 15, 2022"
          type="text"
        ></input>
        <label className="label">Time of event</label>
        <input
          defaultValue={inputText.wedding_time}
          onChange={(e) =>
            setInputText({ ...inputText, wedding_time: e.target.value })
          }
          className="input"
          placeholder="...at 5 O'CLOCK..."
          type="text"
        ></input>
        <label className="label">Location</label>
        <input
          defaultValue={inputText.location}
          onChange={(e) =>
            setInputText({ ...inputText, location: e.target.value })
          }
          className="input"
          placeholder="...terrace on the park 1111 East 12th Street, Chicago IL..."
          type="text"
        ></input>
        <label className="label">Any additional information</label>
        <input
          defaultValue={inputText.extra}
          onChange={(e) =>
            setInputText({ ...inputText, extra: e.target.value })
          }
          className="input"
          placeholder="...dinner will be served! See you there!..."
          type="text"
        ></input>
        <button type="button" id="bton" className="btn btn-lg btn-primary">
          Preview
        </button>
      </div>
    </form>
