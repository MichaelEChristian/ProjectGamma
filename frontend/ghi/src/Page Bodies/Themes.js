...
function Themes(props) {
  ...
  return (
    <div>
      <h1 className="most-popular-themes" style={{ textAlign: 'center' }}>
        Most Popular Themes
      </h1>
      <div className="App">
            ...
            return (
              <Card className="carousel-card" style={{ width: '22rem' }}>
                ...
                <Card.Body>
                  ...
                  <Card.Text>
                    Some quick example text to build on the card title and talk
                    about key features of the theme e.g. Winter Wonderland, etc.
                  </Card.Text>
                  <Button
                    id={index}
                    value={index}
                    onClick={(e) => renderComponent(e, index)}
                    variant="primary"
                  >
                    Learn More
                  </Button>
