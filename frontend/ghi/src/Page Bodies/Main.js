      ...
      <div className="main-pg-container">
        ...
        <div class="hero row">
          <div class="hero__txt container">
            ...
            <h4>Not sure on a destination? Maybe New York City, New York City is a popular choice for couples looking for a city wedding. From classic venues like the Plaza Hotel to modern spaces like the Standard Hotel, New York City has something for every couple.</h4>
          </div>
        </div>
        <main>
            ...
            <div class="container">
              <div class="row">
                <div class="col-sm text-main-1">
                  <p>Nestled on a secluded stretch of golden beach and set against the magnificent mountains of Kauai’s north shore, the intimate<strong> Hanalei Colony Resort </strong>is a paradise on earth. Whether it's a simple wedding ceremony—an intimate occasion for just the two of you, barefoot on the beach at sunset—or a gala wedding and reception with dozens of friends and family, Hanalei Colony provides a wedding that captures the tranquility and beauty of its surroundings.</p>
                </div>
                <div class="col-sm">
                  <img class="img-main-pg" src="https://images.cvent.com/ws/images/venues/17401/Beachcomber-Cafe---Crystal-Cove-Newport-Beach-CA-12e5cb20-bb92-426e-88a3-7b6251035f0d.1646351631.jpeg?unique=true&d=900x450&f=webp" />
                </div>
              </div>
            </div>
          </section>
          <section class="border-main-2">
            <div class="container">
              <div class="row">
                <div class="col-sm">
                  <img class="img-main-pg" src="https://images.cvent.com/ws/images/venues/4108/Sleepy-Ridge-Weddings-Orem-UT-6ec3af93-c5c2-463c-a3e5-a7d16d947b2c.1580848420.jpg?unique=true&d=900x450&f=webp" />
                </div>
                <div class="col-sm text-main-1">
                  <p>Towering over a tranquil pond that reflects its graceful architecture and majestic mountain backdrop,<strong> Sleepy Ridge Weddings </strong>is one of the most breathtaking, stately, and elegant wedding venues in Utah County. With a variety of wedding packages to choose from, the feel of an “old world golf course in Scotland” is at once attainable and uncompromised, catering to your limitations while providing the very best wedding quality.</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className='meet-the-team'>
            <div >
              ...
              <div class="row row-cols-1 row-cols-md-4 g-4">
                <div class="col">
                  <div class="card">
                    <img src={Elijah} class="card-img-top" />
                    <div class="card-body">
                      <h5 class="card-title">Elijah Gilead</h5>
                      <p class="card-text">
                        Write message
                      </p>
                    </div>
                    <div class="card-footer">
                      <small class="text-muted">ICON FOR GIT, LINKEDIN, OTHER LINK YOU WANT TO ADD</small>
                    </div>
                  </div>
                </div>
                <div class="col">
                  <div class="card">
                    <img src={Jenny} class="card-img-top" />
                    <div class="card-body">
                      <h5 class="card-title">Jenny Zhang</h5>
                      <p class="card-text">
                        Write message
                      </p>
                    </div>
                ...
                <div class="col">
                  <div class="card h-100">
                    <img src={hehehehe} class="card-img-top" />
                    <div class="card-body">
                      <h5 class="card-title">Michael Christian</h5>
                      <p class="card-text">
                        Write message
                      </p>
                    </div>
                ...
                <div class="col">
                  <div class="card h-100">
                    <img src={Trung} class="card-img-top" />
                    <div class="card-body">
                      <h5 class="card-title">Trung Nguyen</h5>
                      <p class="card-text">
                        Write message
                      </p>
                    </div>
        ...
        <footer className="main-pg-footer">
          <div>
            <p>
              We had a great time creating this web application assignment. We learned a lot about the technologies and tools that we used, and about problem-solving and working as a team.
            </p>
          </div>
        </footer>
      </div>
